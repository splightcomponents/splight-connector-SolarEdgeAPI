...
class SolarEdgeAPIClient:
    ...
    def get_energy(self, site_id: str, start_date: datetime, end_date: datetime) -> Dict:
    ...
    def get_inverter_data(self, site_id: str, inverter_id: str, start_date: datetime, end_date: datetime) -> Dict:
        url = f"{self._BASE_URL}/site/{site_id}/energy/"
